      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-semibold text-gray-900">Nearby Spots</h2>
            <Link
              to="/map"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Report full bins or problems</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              <h3 className="font-semibold text-gray-900">Adopt a Spot</h3>
              <p className="text-sm text-gray-600">Take ownership of a location</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Track community impact</p>
            </div>
          </Link>
        </div>
      </div>
